...
module.exports = {
    name: "auto-kick",
    category : 'utility',
    description: "mostly for anti-raid, it kicks out the people who are trying to join when this is active",
    aliases: ["ak", "autok"],
    ...
    run: async (client, message, args) => {
        ...
        return message.channel.send(
            new MessageEmbed()
                .setTitle("❌ Error | you need \`KICK_MEMBERS\` to run this command")
                .setColor(0x03fc24)
                .setTimestamp()
